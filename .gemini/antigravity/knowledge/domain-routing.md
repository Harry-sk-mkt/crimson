...
- 실체: 세션 종료 시점에 남기는 리서치/결정 기록 (2026-09-22 생성, 2026-09-25 `decisions/`에서 개명)
- 성격: 도구 불문(Claude Code, Antigravity IDE 등) 세션 컨텍스트를 다음 세션으로 넘기는 로그
- 세부 규칙: `context/CLAUDE.md` 참고
...
4. `meetings/`, `email/`처럼 아직 구조가 없는 도메인은 첫 실질 작업 시점에 이 문서를 갱신한다.
